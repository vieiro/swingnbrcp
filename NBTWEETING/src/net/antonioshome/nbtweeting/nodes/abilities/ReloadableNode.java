...
package net.antonioshome.nbtweeting.nodes.abilities;

/**
 * ReloadableNode is an ability for nodes to be reloaded.
 * @author Antonio Vieiro (antonio@antonioshome.net)
 */
public interface ReloadableNode 
{
  /**
   * Invoked to reload the children of a node.
   * @throws Exception If a problem occurs while refreshing the node's children.
   */
