...
package net.antonioshome.nbtweeting.propertyeditors;
...
/**
 * TimestampPropertyEditor is a PropertyEditor for Dates.
 * The NetBeans Platform has built-in PropertyEditor for most types of
 * data, this is here because we're on a standalone application, and
 * the JDK has no built-in date editor I know of.
 * @author Antonio Vieiro (antonio@antonioshome.net)
 */
public final class TimestampPropertyEditor 
implements PropertyEditor
{
  ...
  public void setAsText(String text) throws IllegalArgumentException {
    SimpleDateFormat sdf = new SimpleDateFormat("dd MMM yyyy HH:mm:ss");
    try {
      this.date = sdf.parse( text );
    } catch (ParseException ex) {
      throw new IllegalArgumentException("Invalid date format, use dd MM yyyy HH:mm:ss instead", ex );
    }
  }
