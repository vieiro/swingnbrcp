...
package net.antonioshome.nbtweeting.entities.abilities;

/**
 * HasTextContent is an ability of entities that have a text content.
 * @author Antonio Vieiro (antonio@antonioshome.net)
 */
public interface HasTextContent 
{
  /**
   * Return the "main text" content of the object.
   * @return The "main text" content of the object.
   */
